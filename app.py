...
# Example fallback URLs in case GitHub is unavailable
MODEL_URLS = {
    ...
    "age_model": "https://raw.githubusercontent.com/opencv/opencv_3rdparty/dnn_samples_face_detector_20170830/age_net.caffemodel"
}

# Alternative download URLs if the primary ones fail
BACKUP_MODEL_URLS = {
